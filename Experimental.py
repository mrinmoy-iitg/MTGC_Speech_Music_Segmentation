...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  3 19:05:57 2022
...
from tensorflow.keras.layers import Dense, BatchNormalization, Input, Dropout, Activation, Conv2D, MaxPooling2D, Concatenate, Cropping2D, Conv1D, Add
...
#         x_cbow_aspt1 = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same')(x_cbow_aspt) # (None, 100, 30, 10)
#         x_cbow_aspt1 = BatchNormalization(axis=-1)(x_cbow_aspt1)
#         x_cbow_aspt = Concatenate(axis=-1)([x_cbow_aspt, x_cbow_aspt1])
        
#         x_cbow_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_cbow_aspt) # (None, 33, 30, 10)
    
#         x_cbow_aspt2 = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,2))(x_cbow_aspt) # (None, 33, 30, 20)
#         x_cbow_aspt2 = BatchNormalization(axis=-1)(x_cbow_aspt2)
#         x_cbow_aspt = Concatenate(axis=-1)([x_cbow_aspt, x_cbow_aspt2])
    
#         x_cbow_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_cbow_aspt) # (None, 11, 30, 10)
    
#         x_cbow_aspt3 = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,4))(x_cbow_aspt) # (None, 11, 30, 30)
#         x_cbow_aspt3 = BatchNormalization(axis=-1)(x_cbow_aspt3)
#         x_cbow_aspt = Concatenate(axis=-1)([x_cbow_aspt, x_cbow_aspt3])
...
#         x_cbow_lspt1 = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same')(x_cbow_lspt) # (None, 100, 30, 10)
#         x_cbow_lspt1 = BatchNormalization(axis=-1)(x_cbow_lspt1)
#         x_cbow_lspt = Concatenate(axis=-1)([x_cbow_lspt, x_cbow_lspt1])
        
#         x_cbow_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_cbow_lspt) # (None, 33, 30, 10)
    
#         x_cbow_lspt2 = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,2))(x_cbow_lspt) # (None, 33, 30, 20)
#         x_cbow_lspt2 = BatchNormalization(axis=-1)(x_cbow_lspt2)
#         x_cbow_lspt = Concatenate(axis=-1)([x_cbow_lspt, x_cbow_lspt2])

#         x_cbow_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_cbow_lspt) # (None, 11, 30, 10)
    
#         x_cbow_lspt3 = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,4))(x_cbow_lspt) # (None, 11, 30, 30)
#         x_cbow_lspt3 = BatchNormalization(axis=-1)(x_cbow_lspt3)
#         x_cbow_lspt = Concatenate(axis=-1)([x_cbow_lspt, x_cbow_lspt3])
...
#         x_stats_aspt1 = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,2))(x_stats_aspt) # (None, 120, 30, nConv)
#         x_stats_aspt1 = BatchNormalization(axis=-1)(x_stats_aspt1)
#         x_stats_aspt = Concatenate(axis=-1)([x_stats_aspt, x_stats_aspt1])
        
#         x_stats_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_aspt) # (None, 40, 30, nConv)
    
#         x_stats_aspt2 = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,4))(x_stats_aspt) # (None, 40, 30, nConv)
#         x_stats_aspt2 = BatchNormalization(axis=-1)(x_stats_aspt2)
#         x_stats_aspt = Concatenate(axis=-1)([x_stats_aspt, x_stats_aspt2])
    
#         x_stats_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_aspt) # (None, 13, 30, 2*nConv)
        
#         x_stats_aspt3 = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same')(x_stats_aspt) # (None, 13, 30, 3*nConv)
#         x_stats_aspt3 = BatchNormalization(axis=-1)(x_stats_aspt3)
#         x_stats_aspt = Concatenate(axis=-1)([x_stats_aspt, x_stats_aspt3])
...
#         x_stats_lspt1 = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,2))(x_stats_lspt) # (None, 120, 30, nConv)
#         x_stats_lspt1 = BatchNormalization(axis=-1)(x_stats_lspt1)
#         x_stats_lspt = Concatenate(axis=-1)([x_stats_lspt, x_stats_lspt1])
        
#         x_stats_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_lspt) # (None, 40, 30, nConv)
    
#         x_stats_lspt2 = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,4))(x_stats_lspt) # (None, 40, 30, nConv)
#         x_stats_lspt2 = BatchNormalization(axis=-1)(x_stats_lspt2)
#         x_stats_lspt = Concatenate(axis=-1)([x_stats_lspt, x_stats_lspt2])
    
#         x_stats_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_lspt) # (None, 13, 30, 2*nConv)
        
#         x_stats_lspt3 = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same')(x_stats_lspt) # (None, 13, 30, 3*nConv)
#         x_stats_lspt3 = BatchNormalization(axis=-1)(x_stats_lspt3)
#         x_stats_lspt = Concatenate(axis=-1)([x_stats_lspt, x_stats_lspt3])
...
def cnn_model(PARAMS):
    ...
    if PARAMS['cbow_feat_input']:
        cbow_input = Input(shape=(100,30,1), name='cbow_feat_input') # (None, 100, 30, 1)
        
        ''' CBoW-ASPT '''
        x_cbow_aspt = Cropping2D(cropping=((0, 50), (0, 0)))(cbow_input) # (None, 50, 30, 1)

        x_cbow_aspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same')(x_cbow_aspt) # (None, 50, 30, 10)
        x_cbow_aspt = BatchNormalization(axis=-1)(x_cbow_aspt)
        # x_cbow_aspt = Dropout(do)(x_cbow_aspt)
        
        x_cbow_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='same')(x_cbow_aspt) # (None, 17, 30, 10)
    
        x_cbow_aspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,2))(x_cbow_aspt) # (None, 17, 30, 20)
        x_cbow_aspt = BatchNormalization(axis=-1)(x_cbow_aspt)
        # x_cbow_aspt = Dropout(do)(x_cbow_aspt)
    
        x_cbow_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='same')(x_cbow_aspt) # (None, 6, 30, 10)
    
        x_cbow_aspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,4))(x_cbow_aspt) # (None, 5, 30, 30)
        x_cbow_aspt = BatchNormalization(axis=-1)(x_cbow_aspt)
        # x_cbow_aspt = Dropout(do)(x_cbow_aspt)
    
        x_cbow_aspt = MaxPooling2D(pool_size=(2,1), strides=(2,1), padding='same')(x_cbow_aspt) # (None, 3, 30, 30)
        
        x_cbow_aspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(3,1), padding='same')(x_cbow_aspt) # (None, 1, 30, 40)
        x_cbow_aspt = BatchNormalization(axis=-1)(x_cbow_aspt)
        # x_cbow_aspt = Dropout(do)(x_cbow_aspt)
        ...
        ''' CBoW-LSPT '''
        x_cbow_lspt = Cropping2D(cropping=((50, 0), (0, 0)))(cbow_input) # (None, 100, 30, 1)

        x_cbow_lspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same')(x_cbow_lspt) # (None, 50, 30, 10)
        x_cbow_lspt = BatchNormalization(axis=-1)(x_cbow_lspt)
        # x_cbow_lspt = Dropout(do)(x_cbow_lspt)
        
        x_cbow_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='same')(x_cbow_lspt) # (None, 17, 30, 10)
    
        x_cbow_lspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,2))(x_cbow_lspt) # (None, 17, 30, 20)
        x_cbow_lspt = BatchNormalization(axis=-1)(x_cbow_lspt)
        # x_cbow_lspt = Dropout(do)(x_cbow_lspt)

        x_cbow_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='same')(x_cbow_lspt) # (None, 6, 30, 10)
    
        x_cbow_lspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(1,1), padding='same' , dilation_rate=(1,4))(x_cbow_lspt) # (None, 6, 30, 30)
        x_cbow_lspt = BatchNormalization(axis=-1)(x_cbow_lspt)
        # x_cbow_lspt = Dropout(do)(x_cbow_lspt)
    
        x_cbow_lspt = MaxPooling2D(pool_size=(2,1), strides=(2,1), padding='valid')(x_cbow_lspt) # (None, 3, 30, 30)
        
        x_cbow_lspt = Conv2D(nConv_cbow, kernel_size=(3,3), strides=(3,1), padding='same')(x_cbow_lspt) # (None, 1, 30, 40)
        x_cbow_lspt = BatchNormalization(axis=-1)(x_cbow_lspt)
        # x_cbow_lspt = Dropout(do)(x_cbow_lspt)
    ...
    if PARAMS['stats_feat_input']:
        stats_feat_input = Input(shape=(120,30,1), name='stats_feat_input')

        ''' stats-ASPT '''
        x_stats_aspt = Cropping2D(cropping=((0, 60), (0, 0)))(stats_feat_input) # (None, 60, 30, 1)
        
        x_stats_aspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,2))(x_stats_aspt) # (None, 60, 30, nConv)
        x_stats_aspt = BatchNormalization(axis=-1)(x_stats_aspt)
        # x_stats_aspt = Dropout(do)(x_stats_aspt)
        
        x_stats_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_aspt) # (None, 20, 30, nConv)
    
        x_stats_aspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,4))(x_stats_aspt) # (None, 20, 30, nConv)
        x_stats_aspt = BatchNormalization(axis=-1)(x_stats_aspt)
        # x_stats_aspt = Dropout(do)(x_stats_aspt)
    
        x_stats_aspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_aspt) # (None, 6, 30, 2*nConv)
        
        x_stats_aspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same')(x_stats_aspt) # (None, 6, 30, 3*nConv)
        x_stats_aspt = BatchNormalization(axis=-1)(x_stats_aspt)
        # x_stats_aspt = Dropout(do)(x_stats_aspt)

        x_stats_aspt = MaxPooling2D(pool_size=(2,1), strides=(2,1), padding='valid')(x_stats_aspt) # (None, 3, 30, 2*nConv)

        x_stats_aspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(3,1), padding='same')(x_stats_aspt) # (None, 1, 30, 3*nConv)
        x_stats_aspt = BatchNormalization(axis=-1)(x_stats_aspt)
        # x_stats_aspt = Dropout(do)(x_stats_aspt)
        ...
        ''' stats-LSPT '''
        x_stats_lspt = Cropping2D(cropping=((60, 0), (0, 0)))(stats_feat_input) # (None, 60, 30, 1)
        
        x_stats_lspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,2))(x_stats_lspt) # (None, 60, 30, nConv_stats)
        x_stats_lspt = BatchNormalization(axis=-1)(x_stats_lspt)
        # x_stats_lspt = Dropout(do)(x_stats_lspt)
        
        x_stats_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_lspt) # (None, 20, 30, nConv_stats)
    
        x_stats_lspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same', dilation_rate=(1,4))(x_stats_lspt) # (None, 20, 30, nConv_stats)
        x_stats_lspt = BatchNormalization(axis=-1)(x_stats_lspt)
        # x_stats_lspt = Dropout(do)(x_stats_lspt)
    
        x_stats_lspt = MaxPooling2D(pool_size=(3,1), strides=(3,1), padding='valid')(x_stats_lspt) # (None, 6, 30, nConv_stats)
        
        x_stats_lspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(1,1), padding='same')(x_stats_lspt) # (None, 6, 30, nConv_stats)
        x_stats_lspt = BatchNormalization(axis=-1)(x_stats_lspt)
        # x_stats_lspt = Dropout(do)(x_stats_lspt)

        x_stats_lspt = MaxPooling2D(pool_size=(2,1), strides=(2,1), padding='valid')(x_stats_lspt) # (None, 3, 30, nConv_stats)
        
        x_stats_lspt = Conv2D(nConv_stats, kernel_size=(3,3), strides=(3,1), padding='same')(x_stats_lspt) # (None, 1, 30, 3*nConv)
        x_stats_lspt = BatchNormalization(axis=-1)(x_stats_lspt)
        # x_stats_lspt = Dropout(do)(x_stats_lspt)
...
def reshape_CBoW_features(PARAMS, data, label, sm_pred, stats, oversample=False):
...
def generator(PARAMS, file_list, batchSize, add_noise=False):
    ...
    while 1:    
        while balance<3*batchSize:
            ...
            fv, lab, pred_sm, fv_stats, patch_labels = reshape_CBoW_features(PARAMS, fv, lab, pred_sm, fv_stats, oversample=minority_oversample)
        ...
        shuffled_idx = list(range(np.shape(batchData_temp)[0]))
        np.random.shuffle(shuffled_idx)
        batchData_temp = batchData_temp[shuffled_idx,:]
        batchData_stats_temp = batchData_stats_temp[shuffled_idx,:]
        batchLabel_temp = batchLabel_temp[shuffled_idx,:]
        sm_pred_temp = sm_pred_temp[shuffled_idx,:]
        ...
        if PARAMS['raw_feat_input']:
            raw_feat_temp = raw_feat_temp[shuffled_idx,:]
...
def __init__():
    PARAMS = {
            ...
            'feature_path': '/home1/PhD/mrinmoy.bhattacharjee/MTGC_SMO/Moviescope/Native_CBoW_Features_2classes_5PT_5mix_2022-02-03/CBoW-ASPT-LSPT/',
            ...
            'feature_path_Stats':'/home1/PhD/mrinmoy.bhattacharjee/MTGC_SMO/Moviescope/Native_CBoW_Features_2classes_5PT_5mix_2022-02-03/Stats-ASPT-LSPT/',
...
if __name__ == '__main__':
    ...
    if PARAMS['raw_feat_input']:
        suffix += '_LMS'
    suffix += '_STL_' + str(int(PARAMS['W']/1000)) + 's'
